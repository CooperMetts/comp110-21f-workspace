...
player: str = ""
points: int = 0  # If this is a global variable (is it?) then why is it giving me error messages in the main function?
        ...
        while points < 10:
            ...
            if points == 9: 
                ...
                if lebron_count > steph_count and lebron_count > giannis_count and lebron_count > harden_count:
                    print(f"{player}, your NBA superstar is Lebron James because you answered {lebron_count} questions the way Lebron would have.")

                if steph_count > lebron_count and steph_count > giannis_count and steph_count > harden_count:
                    print(f"{player}, your NBA superstar is Steph Curry because you answered {steph_count} questions the way Steph would have.")

                if giannis_count > lebron_count and giannis_count > steph_count and giannis_count > harden_count:
                    print(f"{player}, your NBA superstar is Giannis Antetokounmpo because you answered {giannis_count} questions the way Giannis would have.")

                if harden_count > lebron_count and harden_count > steph_count and harden_count > giannis_count:
                    print(f"{player}, your NBA superstar is James Harden because you answered {harden_count} questions the way James would have.")
